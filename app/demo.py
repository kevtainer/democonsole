...
def startDocker():
	...
	try:
		...
		print(dStatus)
		message = {'docker':[{'comp':'Docker', 'ver':dStr, 'status':dStatus}, {'comp':'docker compose', 'ver':dcStr, 'status':'N/A'}, ]}
	except CalledProcessError as ex:
		print(ex)
		message = {'docker':[{'comp':'Docker', 'ver':dStr, 'status':'False'}, {'comp':'docker compose', 'ver':dcStr, 'status':'N/A'}, ]}
	print(message)
	return message
